(function (global, factory) {
...
}(this, (function (React: { useRef: (arg0: number | null) => any; useState: (arg0: boolean) => any; useEffect: (arg0: () => () => void) => void; cloneElement: (arg0: any, arg1: any) => any; createElement: (arg0: any, arg1: { onLayout?: (event: { nativeEvent: { layout: { height: any; width: any; }; }; }) => void; style?: any; horizontal?: boolean; bounces?: boolean; scrollEnabled?: boolean; showsHorizontalScrollIndicator?: boolean; }, arg2: undefined, arg3: undefined, arg4: undefined) => any; }, reactNative: { Animated: { Value: new (arg0: number) => any; loop: (arg0: any) => { (): any; new(): any; start: { (): void; new(): any; }; }; timing: (arg0: any, arg1: { toValue: any; duration: any; delay: any; easing: any; useNativeDriver: boolean; }) => any; View: any; }; Easing: { linear: any; }; View: any; ScrollView: any; }) {
    'use strict';
    ...
    ***************************************************************************** */
    ...
    var __assign = function (p0: {}, childrenProps: any) {
    ...
    var AutoScrolling = function (_a) {
        ...
        function measureContainerView(event: { nativeEvent: { layout: { height: any; width: any; }; }; }) {
            ...
            contentRef.current.measure(function (fx: any, fy: any, width: any, height: any) {
                isVertical ? checkContent(height, fy) : checkContent(width, fx);
            });
        }
        function checkContent(newContentSize: any, fx: any) {
            if (!newContentSize) {
        ...
        function measureContentView(event: { nativeEvent: { layout: any; }; }) {
        ...
        var childrenWithProps = React.cloneElement(children, __assign(__assign({}, childrenProps), {
            onLayout: measureContentView, ref: function (ref: any) {
